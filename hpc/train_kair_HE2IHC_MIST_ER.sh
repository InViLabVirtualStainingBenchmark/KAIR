...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/kair_MIST_ER_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/kair_MIST_ER_%j.err
set -euo pipefail
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/kair_MIST_ER_vaughan"
mkdir -p "$OUTPUT_DIR"
...
srun apptainer exec \
    ...
    python3 main_train_psnr.py \
        --opt options/swinir/train_swinir_HE2IHC_MIST_ER_HPC.json \
