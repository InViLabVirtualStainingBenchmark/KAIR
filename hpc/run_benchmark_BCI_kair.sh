#!/bin/bash
#SBATCH --job-name=infer_kair_BCI
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/infer_kair_BCI_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/infer_kair_BCI_%j.err
...
echo "Done — results at: ${OUTPUT_BASE}/kair_BCI"
