...
OUTPUT_DIR="$VSC_DATA/projects/outputs/kair_IHC_denoise_MIST_Ki67"
...
srun apptainer exec \
    ...
    -B "$OUTPUT_DIR":/output \
    "$CONTAINER" \
    bash /code/KAIR/train_kair_IHC_denoise.sh options/swinir/train_swinir_IHC_denoise_MIST_Ki67_HPC.json
