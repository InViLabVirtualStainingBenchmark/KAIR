...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/kair_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/kair_%j.err

set -euo pipefail

CONTAINER="$VSC_SCRATCH/containers/uformer_nvidia.sif"
CODE_DIR="$VSC_DATA/projects/code"
DATA_SQSH="$VSC_SCRATCH/BCI_Uformer.sqsh"
OUTPUT_DIR="$VSC_DATA/projects/outputs/kair"
